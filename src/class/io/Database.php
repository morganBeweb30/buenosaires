...
class Database extends mysqli{
  ...
  /*   ERREUR N'EMPECHE PAS CONNEXION A LA BDD  210203
    Peut-être juste utilisation d'un nom de méthode réservé ?
  ...
  private function into_db_insert($obj, $values){
      ...
      while($result === FALSE && $max_try > 0){
          if(!isset($obj->id)){
              ...
              if($new_id == 0){
                  /*  Notice: Undefined property: Prenom::$table_name in buenosaires/src/class/io/Database.php on line 571  ***/
